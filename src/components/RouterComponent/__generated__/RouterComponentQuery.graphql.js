/**
 * @flow
 * @relayHash aea6a204b1dc470e6dabda40d5c989e2
 */
...
export type RouterComponentQueryVariables = {|
  input: MapLayerInput
|};
export type RouterComponentQueryResponse = {|
  +indicatorMapLayer: ?{|
    +indicators: ?{|
      +edges: $ReadOnlyArray<?{|
        +node: ?{|
  ...
  |}
|};
export type RouterComponentQuery = {|
  variables: RouterComponentQueryVariables,
  response: RouterComponentQueryResponse,
|};
*/


/*
query RouterComponentQuery(
  $input: MapLayerInput!
) {
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "RouterComponentQuery",
  "id": null,
  "text": "query RouterComponentQuery(\n  $input: MapLayerInput!\n) {\n  indicatorMapLayer(layer: $input) {\n    indicators {\n      edges {\n        node {\n          id\n          indicatorName\n          year\n          geographicUnit {\n            summaryLevelCode\n            id\n          }\n          dataDictionaryVariable {\n            baseMultiplier\n            isLargerBetter\n            showDecimalPlaces\n            unitOfMeasure\n            searchableindicatorSet {\n              edges {\n                node {\n                  id\n                  geographicUnit {\n                    name\n                    summaryLevelCode\n                    id\n                  }\n                }\n              }\n            }\n            id\n          }\n          mapLegend {\n            edges {\n              node {\n                quantile\n                legendText\n                id\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "RouterComponentQuery",
...
// prettier-ignore
(node/*: any*/).hash = '41b81d0fea38b8c050d05837e2b3c7ce';
module.exports = node;
