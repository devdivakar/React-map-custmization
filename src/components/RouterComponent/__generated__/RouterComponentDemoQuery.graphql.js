/**
 * @flow
 * @relayHash 2d694e721bcca473d4e8ae62a9e067cc
 */
...
export type RouterComponentDemoQueryVariables = {|
  input: MapLayerInput
|};
export type RouterComponentDemoQueryResponse = {|
  +indicatorMapLayer: ?{|
    +indicators: ?{|
      +edges: $ReadOnlyArray<?{|
        +node: ?{|
  ...
  |}
|};
export type RouterComponentDemoQuery = {|
  variables: RouterComponentDemoQueryVariables,
  response: RouterComponentDemoQueryResponse,
|};
*/


/*
query RouterComponentDemoQuery(
  $input: MapLayerInput!
) {
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "RouterComponentDemoQuery",
  "id": null,
  "text": "query RouterComponentDemoQuery(\n  $input: MapLayerInput!\n) {\n  indicatorMapLayer(layer: $input) {\n    indicators {\n      edges {\n        node {\n          id\n          indicatorName\n          year\n          geographicUnit {\n            summaryLevelCode\n            id\n          }\n          dataDictionaryVariable {\n            baseMultiplier\n            isLargerBetter\n            showDecimalPlaces\n            unitOfMeasure\n            searchableindicatorSet {\n              edges {\n                node {\n                  id\n                  geographicUnit {\n                    name\n                    summaryLevelCode\n                    id\n                  }\n                }\n              }\n            }\n            id\n          }\n          mapLegend {\n            edges {\n              node {\n                quantile\n                legendText\n                id\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}\n",
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
    "name": "RouterComponentDemoQuery",
...
// prettier-ignore
(node/*: any*/).hash = 'e8a2a9d86d043c46c15db4d2baadeba0';
module.exports = node;
